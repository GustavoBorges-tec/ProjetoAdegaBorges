...
export default function Drink({navigation,route}){ 
    ...
    React.useEffect(()=>{
        fetch("http://10.26.49.45:5000/drinks/listar")
    ...
    return(
        <View style={styles.paineldrink}>
            
            <Image source={require("../assets/caipirinha.png")} 
            style={{width:"100%",height:200,resizeMode:"cover", marginTop:-520}}/>

            <ScrollView horizontal={false} style={styles.scrollviewhome}>

            <View style={styles.drink}>
            <Image source={require("../assets/drinks.png")}/>
            </View>

                <View style={styles.listadrink}>
